...
module PayQuickerSdk
  ...
  class StatementResult < BaseModel
    ...
    def initialize(file_contents = SKIP, filename = SKIP, mime_type = SKIP,
                   ...
                   from = SKIP, to = SKIP, links = SKIP, meta = SKIP,
    ...
    def self.from_hash(hash)
      ...
      StatementResult.new(file_contents,
                          filename,
                          mime_type,
                          token,
                          user_token,
    ...
    def to_s
      ...
      " #{@prepaid_card_token}, from: #{@from}, to: #{@to}, links: #{@links}, meta: #{@meta},"\
    ...
    def inspect
      ...
      " #{@from.inspect}, to: #{@to.inspect}, links: #{@links.inspect}, meta: #{@meta.inspect},"\
      " additional_properties: #{get_additional_properties}>"
    end
  end
end
