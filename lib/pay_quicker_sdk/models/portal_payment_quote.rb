...
module PayQuickerSdk
  ...
  class PortalPaymentQuote < BaseModel
    ...
    def initialize(amount = 1.02, currency = Currencies::USD,
                   ...
                   auto_accept_quote = SKIP, not_before = SKIP,
                   not_after = SKIP, additional_properties = {})
    ...
    def to_s
      ...
      " purpose: #{@purpose}, client_payment_id: #{@client_payment_id}, auto_accept_quote:"\
    ...
    def inspect
      ...
      " #{@purpose.inspect}, client_payment_id: #{@client_payment_id.inspect}, auto_accept_quote:"\
      " #{@auto_accept_quote.inspect}, not_before: #{@not_before.inspect}, not_after:"\
      " #{@not_after.inspect}, additional_properties: #{get_additional_properties}>"
    end
  end
end
