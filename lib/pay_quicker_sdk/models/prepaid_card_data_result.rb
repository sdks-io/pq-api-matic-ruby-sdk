...
module PayQuickerSdk
  # PrepaidCardDataResult Model.
  class PrepaidCardDataResult < BaseModel
    SKIP = Object.new
    ...
    def initialize(card_number = SKIP, cvv_number = SKIP, expiration = SKIP,
                   name_on_card = SKIP, token = SKIP, links = SKIP, meta = SKIP,
    ...
    def self.from_hash(hash)
      ...
      PrepaidCardDataResult.new(card_number,
                                cvv_number,
                                expiration,
                                name_on_card,
                                token,
    ...
    def to_s
      ...
      " #{@expiration}, name_on_card: #{@name_on_card}, token: #{@token}, links: #{@links}, meta:"\
    ...
    def inspect
      ...
      " #{@token.inspect}, links: #{@links.inspect}, meta: #{@meta.inspect},"\
