...
module PayQuickerSdk
  ...
  class PaymentJobObject < BaseModel
    ...
    def initialize(token = SKIP, portal_id = SKIP, filename = SKIP,
                   ...
                   status = SKIP, items = SKIP, links = SKIP,
    ...
    def to_s
      ...
      " #{@count}, type: #{@type}, status: #{@status}, items: #{@items}, links: #{@links},"\
    ...
    def inspect
      ...
      " status: #{@status.inspect}, items: #{@items.inspect}, links: #{@links.inspect},"\
      " additional_properties: #{get_additional_properties}>"
    end
  end
end
