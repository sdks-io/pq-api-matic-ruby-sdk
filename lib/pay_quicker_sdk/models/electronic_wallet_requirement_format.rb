...
module PayQuickerSdk
  ...
  class ElectronicWalletRequirementFormat < BaseModel
    SKIP = Object.new
    ...
    # Example of a requirement generated from the validator(s)
    # @return [Array[ElectronicWalletRequirementFormatLegend]]
    ...
    def self.from_hash(hash)
      ...
      unless hash['legend'].nil?
        ...
        hash['legend'].each do |structure|
          legend << (ElectronicWalletRequirementFormatLegend.from_hash(structure) if structure)
        end
      end
      ...
      ElectronicWalletRequirementFormat.new(example,
                                            legend,
