...
module PayQuickerSdk
  # [Validator
  # type](#/rest/models/structures/electronic-wallet-requirement-validator) that
  # for the required electronic wallet information.
  class ElectronicWalletRequirementValidator < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      ElectronicWalletRequirementValidator.new(expression,
                                               validator_type,
                                               additional_properties)
    end
