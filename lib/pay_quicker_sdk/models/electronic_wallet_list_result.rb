...
module PayQuickerSdk
  # ElectronicWalletListResult Model.
  class ElectronicWalletListResult < BaseModel
    SKIP = Object.new
    private_constant :SKIP

    # TODO: Write general description for this method
    # @return [Array[ElectronicWalletObject]]
    ...
    def self.from_hash(hash)
      ...
      unless hash['payload'].nil?
        ...
        hash['payload'].each do |structure|
          payload << (ElectronicWalletObject.from_hash(structure) if structure)
        end
      end
      ...
      ElectronicWalletListResult.new(payload,
                                     meta,
                                     links,
                                     additional_properties)
    end
