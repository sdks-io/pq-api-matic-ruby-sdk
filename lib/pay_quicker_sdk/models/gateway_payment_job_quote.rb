...
module PayQuickerSdk
  ...
  class GatewayPaymentJobQuote < BaseModel
    ...
    def self.from_hash(hash)
      ...
      GatewayPaymentJobQuote.new(amount,
                                 currency,
                                 source_token,
                                 destination_token,
                                 note,
    ...
    def to_s
      ...
      " #{@purpose}, client_payment_id: #{@client_payment_id}, additional_properties:"\
    ...
    def inspect
      ...
      " #{@client_payment_id.inspect}, additional_properties: #{get_additional_properties}>"
    end
  end
end
