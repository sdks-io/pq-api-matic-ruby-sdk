...
module PayQuickerSdk
  # 1...N required
  # [fields](#/rest/models/structures/key-value-pair-electronic-wallet-field-typ
  # es-string) as determined by call to get requirements
  class ElectronicWalletField < BaseModel
    SKIP = Object.new
