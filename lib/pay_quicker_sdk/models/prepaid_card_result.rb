...
module PayQuickerSdk
  # PrepaidCardResult Model.
  class PrepaidCardResult < BaseModel
    SKIP = Object.new
    ...
    def initialize(token = SKIP, card_network = SKIP, card_number = SKIP,
                   ...
                   user_token = SKIP, links = SKIP, meta = SKIP,
    ...
    def to_s
      ...
      " user_token: #{@user_token}, links: #{@links}, meta: #{@meta}, additional_properties:"\
    ...
    def inspect
      ...
      " user_token: #{@user_token.inspect}, links: #{@links.inspect}, meta: #{@meta.inspect},"\
