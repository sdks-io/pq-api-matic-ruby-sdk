...
module PayQuickerSdk
  ...
  class GatewayTransferQuote < BaseModel
    ...
    def initialize(
      ...
      note = SKIP, memo = SKIP, auto_accept_quote = SKIP,
      client_transfer_id = SKIP, destination_amount = SKIP,
      destination_currency = Currencies::USD, transfer_lock_side = SKIP,
      transfer_method_type = SKIP, additional_properties = {}
    )
    ...
    def self.from_hash(hash)
      ...
      GatewayTransferQuote.new(source_token,
                               destination_token,
                               note,
                               memo,
                               auto_accept_quote,
    ...
    def to_s
      ...
      " note: #{@note}, memo: #{@memo}, auto_accept_quote: #{@auto_accept_quote},"\
      " client_transfer_id: #{@client_transfer_id}, destination_amount: #{@destination_amount},"\
      " destination_currency: #{@destination_currency}, transfer_lock_side:"\
      " #{@transfer_lock_side}, transfer_method_type: #{@transfer_method_type},"\
    ...
    def inspect
      ...
      " #{@destination_token.inspect}, note: #{@note.inspect}, memo: #{@memo.inspect},"\
      " auto_accept_quote: #{@auto_accept_quote.inspect}, client_transfer_id:"\
