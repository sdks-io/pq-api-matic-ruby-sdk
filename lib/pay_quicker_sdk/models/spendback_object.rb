...
module PayQuickerSdk
  ...
  class SpendbackObject < BaseModel
    ...
    def initialize(
      ...
      refunds = SKIP, links = SKIP, additional_properties = {}
    )
    ...
    def to_s
      ...
      " #{@receipt_token}, refunds: #{@refunds}, links: #{@links}, additional_properties:"\
    ...
    def inspect
      ...
      " #{@refunds.inspect}, links: #{@links.inspect}, additional_properties:"\
      " #{get_additional_properties}>"
    end
  end
end
