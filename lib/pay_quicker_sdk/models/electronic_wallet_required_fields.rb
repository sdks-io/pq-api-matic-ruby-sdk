...
module PayQuickerSdk
  ...
  class ElectronicWalletRequiredFields < BaseModel
    SKIP = Object.new
    private_constant :SKIP

    # Classifies the
    # [format](#/rest/models/structures/electronic-wallet-requirement-format) of
    # the required information for an electronic wallet
    # @return [ElectronicWalletRequirementFormat]
    ...
    # Localized requirement description for display purposes
    # @return [Array[ElectronicWalletRequirementValidator]]
    ...
    def self.from_hash(hash)
      ...
      format = ElectronicWalletRequirementFormat.from_hash(hash['format']) if hash['format']
      ...
      unless hash['validators'].nil?
        ...
        hash['validators'].each do |structure|
          validators << (ElectronicWalletRequirementValidator.from_hash(structure) if structure)
        end
      end
      ...
      ElectronicWalletRequiredFields.new(format,
                                         requirement,
                                         description,
                                         validators,
