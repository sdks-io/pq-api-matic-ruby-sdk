...
module PayQuickerSdk
  # ElectronicWalletRequirementListResult Model.
  class ElectronicWalletRequirementListResult < BaseModel
    SKIP = Object.new
    private_constant :SKIP

    # TODO: Write general description for this method
    # @return [Array[ElectronicWalletRequirement]]
    ...
    def self.from_hash(hash)
      ...
      unless hash['payload'].nil?
        ...
        hash['payload'].each do |structure|
          payload << (ElectronicWalletRequirement.from_hash(structure) if structure)
        end
      end
      ...
      ElectronicWalletRequirementListResult.new(payload,
                                                links,
                                                meta,
                                                additional_properties)
    end
