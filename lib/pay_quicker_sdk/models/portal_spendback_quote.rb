...
module PayQuickerSdk
  ...
  class PortalSpendbackQuote < BaseModel
    ...
    def initialize(
      amount = 1.02, currency = Currencies::USD, program_user_id = SKIP,
      email = SKIP,
    ...
    def self.from_hash(hash)
      ...
      PortalSpendbackQuote.new(amount,
                               currency,
                               program_user_id,
                               email,
                               destination_token,
    ...
    def to_s
      ...
      "<#{class_name} amount: #{@amount}, currency: #{@currency}, program_user_id:"\
      " #{@program_user_id}, email: #{@email}, destination_token: #{@destination_token}, memo:"\
      " #{@memo}, note: #{@note}, client_spendback_id: #{@client_spendback_id}, auto_accept_quote:"\
      " #{@auto_accept_quote}, additional_properties: #{get_additional_properties}>"
    end
    ...
    def inspect
      ...
      " client_spendback_id: #{@client_spendback_id.inspect}, auto_accept_quote:"\
